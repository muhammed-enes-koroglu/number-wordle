...
def get_secret_code() -> Tuple[str, int]:
    ...
    secret_code:str = getpass.getpass('Enter the secret code, or type `random` if you want a random secret code: ')
    # Handle random secret code.
    if(secret_code == 'random'):
...
if __name__ == "__main__":
    ...
    while(guess != 'quit'):
        ...
        # Check if the guess conforms the rules.
